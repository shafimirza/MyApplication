...
public class FragmentContainerActivity extends ActionBarActivity
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        {
            case 0:
                display = new FrontDeskFragment();
                break;
            case 1:
                display = new MaintenanceFragment();
                break;
            case 2:
                display = new CreateUserFragment();
                break;
            case 3:
                display = new HousekeepingFragment();
                break;
            case 4:
                this.invalidateOptionsMenu();
                display = new TasksFragment();
                break;
            default:
                display = new FrontDeskFragment();
                break;
        ...
        fMan.beginTransaction()
                .replace(R.id.container, display).commit();
